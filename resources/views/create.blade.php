                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_number" type="text" class="form-control @error('id_number') is-invalid @enderror" name="id_number" autocomplete="id_number" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="text" class="form-control @error('age') is-invalid @enderror" name="age" autocomplete="age" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city"  autocomplete="city" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control @error('mobile_number') is-invalid @enderror" name="mobile_number"  autocomplete="mobile_number" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="grades" type="text" class="form-control @error('grades') is-invalid @enderror" name="grades" autocomplete="grades" autofocus>
